...
export const DEFAULT_PRESETS: Preset[] = [
  ...
  { id: 'p3', name: '畅快游戏', duration: 90, color: 'text-indigo-900', accent: '#4f46e5', icon: 'game', isEssential: true },
  { id: 'p4', name: '静心冥想', duration: 20, color: 'text-teal-900', accent: '#0d9488', icon: 'flow', isEssential: true },
  { id: 'p5', name: '研读充电', duration: 45, color: 'text-rose-900', accent: '#e11d48', icon: 'read', isEssential: true },
